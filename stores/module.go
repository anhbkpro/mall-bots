...
func (m Module) Startup(ctx context.Context, mono monolith.Monolith) error {
	...
	participatingStores := postgres.NewParticipatingStoreRepository("stores.participating_stores", mono.DB())
	...
	fmt.Println("stores module started")
	return nil
}
