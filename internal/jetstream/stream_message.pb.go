...
const file_stream_message_proto_rawDesc = "" +
	"\n" +
	"\x14stream_message.proto\x12\tjetstream\x1a\x1fgoogle/protobuf/timestamp.proto\"G\n" +
	"\rStreamMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04data\x18\x03 \x01(\fR\x04dataB\x89\x01\n" +
	"\rcom.jetstreamB\x12StreamMessageProtoP\x01Z eda-in-golang/internal/jetstream\xa2\x02\x03JXX\xaa\x02\tJetstream\xca\x02\tJetstream\xe2\x02\x15Jetstream\\GPBMetadata\xea\x02\tJetstreamb\x06proto3"
